...
Every week, after you finish working through the content, I want to hear about what you learned and what questions you still have. To encourage engagement with the course content—and to allow me to collect the class's questions each week—you'll need to write a short response as part of your exercise. This should be ≈150 words. That's fairly short: there are ≈250 words on a typical double-spaced page in Microsoft Word (500 when single-spaced).
